...
export {
    type general_log: record {
        ...
        read_audit_log_power_up_time                                                            : time &log &optional;
        read_audit_log_last_security_change                                                     : time &log &optional;
    ...
    type session_log_record_log: record {
        ...
        session_log_record_connect_time                                         : time &log &optional;
        session_log_record_disconnect_time                                      : time &log &optional;
